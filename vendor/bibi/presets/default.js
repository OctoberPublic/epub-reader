...
"autostart-embedded"            : "yes", // [本アプリで変更] iframe 埋め込みでも自動起動する(全画面 iframe で使うため)
"start-embedded-in-new-window"  : "no", // [本アプリで変更] 別ウィンドウで開かない(埋め込み内で表示)
...
"orientation-border-ratio"   : 1.1, // [本アプリで変更] 横長(iPad横向き4:3≈1.333)で確実に landscape=見開きにし、縦向きは単ページを維持(元: 1*2/1.5≈1.333 は 4:3 と同値で境界が不安定だった)
